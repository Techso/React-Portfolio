	...
	return (
		<div>
			<section className="slide-out">
				<section id="contact" className="[ Contact ] [ pad-around-lg ]">
					<div className="[ Contact__inner ] [ wrapper sf-flow pad-before ]">
						<div className="[ Contact__content ] [ sf-flow ]">
							<h2 className="[ Contact__heading ] [ h1 ]">
								Hey there!
							</h2>
							<p className="[ font-sans-serif h5 ]">
								Want to create magic with me ?.
							</p>
							<p className="[ h6 ]">
								<a
									href="mailto:faithadeoti21@gmail.com"
									className="[ js-hover ] [ link ]"
								>
									send me an email
								</a>
								at faithadeoti21@gmail.com
								<br />
								or give me a shout on my socials.
							</p>
							<div className="[ Contact__social ] [ js-hover ]">
								<a
									href="https://twitter.com/I_am_Techso"
									rel="external"
									target="_blank"
									className="[ none ]"
								>
								...
								<a
									href="https://www.linkedin.com/in/faith-adeoti-ab2131114/"
									rel="external"
									target="_blank"
									className="[ none ]"
								>
						...
						>
							...
							<path
								d="M1040.82,611.12q-1.74,3.75-3.47,7.4-2.7,5.67-5.33,11.12c-.78,1.61-1.56,3.19-2.32,
						4.77-8.6,17.57-16.63,33.11-23.45,45.89A73.21,73.21,0,0,1,942.44,
						719l-151.65,1.65h-1.6l-13,.14-11.12.12-34.1.37-1.38,0-17.36.19h-.53l-107,
						1.16-95.51,1-11.11.12-69,.75H429l-44.75.48h-.48l-141.5,1.53-42.33.46a88.07,88.07,0,0,1-26.67-3.82,86.39,86.39,0,0,
						1-39.09-24.75C116,678.37,102.75,655,93.85,629.64q-1.93-5.49-3.6-11.12C59.44,514.37,97,
						380,164.6,290.08q4.25-5.64,8.64-11l.07-.08c20.79-25.52,44.1-46.84,68.93-62,44-26.91,92.75-34.49,140.7-11.9,40.57,
						19.12,78.45,28.11,115.17,30.55,3.71.24,7.42.42,11.11.53,84.23,2.65,163.17-27.7,255.87-47.29,3.69-.78,
						7.39-1.55,11.12-2.28,66.13-13.16,139.49-20.1,226.73-5.51a189.09,189.09,0,0,1,26.76,6.4q5.77,1.86,11.12,4c41.64,16.94,64.35,
						48.24,74,87.46q1.37,5.46,2.37,11.11C1134.3,384.41,1084.19,518.23,1040.82,611.12Z"
